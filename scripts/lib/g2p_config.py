...
The vocabulary of accepted input values and the decoders that turn raw
action-input strings into Python values live in
:mod:`g2p_config_inputs`; they are re-exported here so callers keep a
